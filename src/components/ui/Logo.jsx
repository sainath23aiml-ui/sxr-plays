...
const Logo = ({ className = "" }) => {
  return (
    <div className={clsx("flex items-center gap-3 select-none group cursor-default", className)}>
      <div className="w-10 h-10 bg-[#00ff88] rounded-[8px] flex items-center justify-center shadow-[0_0_20px_rgba(0,255,136,0.4)] group-hover:scale-110 transition-transform duration-500">
